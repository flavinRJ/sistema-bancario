...
def sacar(*, saldo, valor, extrato, limite, numero_saques, limite_saques):
    ...
    if excedeu_saldo:
        ...
        print("Valor de limite de saques excedido.")
...
def criar_usuario(usuarios):
    ...
    usuarios.append({"nome": nome, "data_de_nacimento": data_de_nascimento, "cpf": cpf, "endereco": endereco })
...
def main():
    ...
    while True:
        ...
        if opcao == "d":
            ...
            print("Favor selecione a opção desejada.")
